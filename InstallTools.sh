...
wget -c https://github.com/MasterDevX/Termux-ADB/raw/master/bin/adb -P $downpath/ 
echo -e "\e[32m[*] \e[34mDownloading binaries..."
wget -c https://github.com/MasterDevX/Termux-ADB/raw/master/bin/adb.bin -P $downpath/ 
wget -c https://github.com/MasterDevX/Termux-ADB/raw/master/bin/fastboot -P $downpath/ 
wget -c https://github.com/MasterDevX/Termux-ADB/raw/master/bin/fastboot-armeabi -P $downpath/ 
